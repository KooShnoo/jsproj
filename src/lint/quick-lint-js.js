...
// see the original source at https://github.com/quick-lint/quick-lint-js/blob/63e6b0aa555a196eca8cf7dff4a582f72bd1beae/website/wasm/quick-lint-js.js
...
export class ProcessAborted extends ProcessCrashed {}

export class ProcessCrashedWithUnknownError extends ProcessCrashed {
  ...
  async createProcessAsync() {
    ...
    let wasmInstance = await WebAssembly.instantiate(this._wasmModule, {
      ...
      wasi_snapshot_preview1: {
        ...
        fd_write: () => {
          throw new Error("Not implemented: fd_write");
        },
      },
    });
